...
## recent renew
- 已加强登录密码加密以及采用JWT来进行cookies授权方式，基本满足一般用户需求。
...
#### 变量 `JWT_SECRET` 通过网页生成JWT 密钥 [点击这里](https://generate-secret.vercel.app/32)

- 这个网站会自动生成一个安全的随机密钥。

#### 变量 `AUTH_PASSWORD_HASH`通过网页加密你的密码,生成**密码hash** [点击这里](https://bcrypt-generator.com/)
- 输入你想要的密码
- 选择 10~12 轮加密（rounds）
- 点击生成，得到哈希值
